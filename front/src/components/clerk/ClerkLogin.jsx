        ...
        <div className="min-h-screen bg-gray-900 relative overflow-hidden">
                        ...
                        >
                            <div className="inline-flex items-center">
                                ...
                                <span className="ml-3 text-xl font-bold text-white">
                                    <span className="text-indigo-400">AcademiX</span> Clerk
                                </span>
                            </div>
                        </motion.div>
                        
                        <h1 className="mb-4 font-bold text-4xl bg-gradient-to-r from-indigo-400 to-indigo-500 bg-clip-text text-transparent">Staff Access</h1>
                ...
                <div className="flex justify-center self-center z-10">
                    ...
                    >
                        <div className="mb-8 text-center">
                            <h3 className="font-bold text-2xl text-white mb-2">Clerk Login</h3>
                        ...
                        {/* <div className="grid grid-cols-2 gap-3 mb-6">
                            <div className="flex items-center justify-center gap-2 p-3 border border-indigo-500/30 rounded-xl bg-indigo-900/20 group">
                                <i className="ri-file-list-3-line text-indigo-400 group-hover:scale-110 transition-transform"></i>
                                <span className="text-sm text-indigo-300 font-medium">Records</span>
                            </div>
                            <div className="flex items-center justify-center gap-2 p-3 border border-indigo-500/30 rounded-xl bg-indigo-900/20 group">
                                <i className="ri-customer-service-2-line text-indigo-400 group-hover:scale-110 transition-transform"></i>
                                <span className="text-sm text-indigo-300 font-medium">Services</span>
                            </div>
                        </div> */}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            {/* <div className="bg-indigo-900/30 border border-indigo-700 rounded-xl p-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-semibold text-indigo-300 mb-2">Staff Access Information</h4>
                                        <p className="text-sm text-indigo-200">
                                            Use your assigned employee ID and secure password to access the system
                                        </p>
                                    </div>
                                </div>
                            </div> */}
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <i className="ri-user-settings-line text-indigo-500 group-focus-within:text-indigo-400 transition-colors"></i>
                                    </div>
                                    <input
                                        type="text"
                                        name="employeeId"
                            ...
                            <div className="flex items-center justify-between mt-2">
                                <label className="flex items-center group cursor-pointer">
                                    ...
                                    <span className="ml-3 text-sm text-gray-400 group-hover:text-gray-300">Remember staff session</span>
                                </label>
            ...
            <div className="absolute bottom-0 left-0 right-0 pointer-events-none">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                    <path fill="url(#clerkGradient)" fillOpacity="0.15" d="M0,224L80,197.3C160,171,320,117,480,117.3C640,117,800,171,960,197.3C1120,224,1280,224,1360,224L1440,224L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
                    <defs>
                        <linearGradient id="clerkGradient" x1="0%" y1="0%" x2="100%" y2="0%">
